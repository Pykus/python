...
| 2026-09-24 | 15. CP-SAT regression guardrails | `python/cp-sat-solver-regression-guardrails.md` | Sanitized deployment guardrail pattern for a real scheduling solver: completeness, seed sweep, runtime, fairness, spillover, human checks and fail-closed reporting. | `sanitized_internal_example` |
